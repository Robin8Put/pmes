...
class Test_SC(QtumContractHandler):
    ...
    def add_num(self, a):
        return self.call_contract(func_name='add_num', input_types=['uint256'], input_values=[a], output_types=['uint256'])

    def get_all(self):
        return self.call_contract(func_name='get_all', input_types=None, input_values=None, output_types=['uint256', 'string'])

    def get_num(self):
        return self.call_contract(func_name='get_num', input_types=None, input_values=None, output_types=['uint256'])

    def get_str(self):
        return self.call_contract(func_name='get_str', input_types=None, input_values=None, output_types=['string'])

    def set_num(self, num):
        return self.send_to_contract(func_name='set_num', input_types=['uint'], input_values=[num], output_types=['uint'])

    def set_str(self, str):
        return self.send_to_contract(func_name='set_str', input_types=['string'], input_values=[str], output_types=['string'])
